...
latex_documents = [
  ('index', 'weave-ref.tex', 'Weave Reference Guide', _stdauthor, 'manual'),
]
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(weave.__file__))

    if 'dev' in weave.__version__:
        return "http://github.com/scipy/weave/blob/master/weave/%s%s" % (
           fn, linespec)
    else:
        return "http://github.com/scipy/weave/blob/v%s/weave/%s%s" % (
           weave.__version__, fn, linespec)
