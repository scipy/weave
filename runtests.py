...
PROJECT_MODULE = "weave"
PROJECT_ROOT_FILES = ['weave', 'LICENSE.txt', 'setup.py']
SAMPLE_TEST = "weave/tests/test_ext_tools.py:TestAssignVariableTypes.test_assign_variable_types"
SAMPLE_SUBMODULE = "ext_tools"
